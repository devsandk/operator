...
import autolugstor.operator.frames.AddpaycellPanel;
...
public class AddpaycellFrame extends JFrame {

   private static final long serialVersionUID = 1L;
   private Configuration cfg;


   public AddpaycellFrame(ManagerFrames mf, Configuration config, Session sess, List<SSAction> act, SurchageClass sClass, Logger log) {
      ...
      try {
         ...
         AddpaycellPanel buttonPanel = new AddpaycellPanel(mf, e.width, e.height, this.cfg, this, sess, act, sClass, log);
         Container container = this.getContentPane();
         container.add(buttonPanel, "Center");
         act.add(buttonPanel);
      } catch (Exception var10) {
         log.log(new Throwable(), var10);
      }
