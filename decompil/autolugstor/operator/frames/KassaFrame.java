...
import autolugstor.operator.frames.KassaPanel;
...
public class KassaFrame extends JFrame {
   ...
   public KassaFrame(ManagerFrames mf, Configuration config, Session sess, List<SSAction> act, Logger log) {
      ...
      try {
         ...
         KassaPanel buttonPanel = new KassaPanel(mf, e.width, e.height, this.cfg, this, sess, act, log);
