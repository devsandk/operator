...
import autolugstor.operator.frames.AdminPanel;
...
public class AdminFrame extends JFrame {
   ...
   public AdminFrame(ManagerFrames mf, Configuration config, Session sess, List<SSAction> act, Logger log) {
      ...
      try {
         ...
         AdminPanel buttonPanel = new AdminPanel(mf, e.width, e.height, this.cfg, this, sess, act, log);
