...
public class ManagerImageAnimationItem {
   ...
   public ManagerImageAnimationItem(int screenwidth, int screenheight, Image img, String xalign, String yalign, int X, int Y, int W, int H, int il, int ir, int it, int ib) {
