...
// TestNFC663.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTestNFC663App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CTestNFC663App

CTestNFC663App::CTestNFC663App()
{
...
// Единственный объект CTestNFC663App

CTestNFC663App theApp;


// инициализация CTestNFC663App

BOOL CTestNFC663App::InitInstance()
{
