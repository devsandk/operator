...
class Reader:
    ...
    def get_card(self):
        ...
        self.conn.read(10)
        self.conn.write(array.array('B', [0xfd, 0x00, 0x02, 0x07, 0x00, 0x01, 0x02, 0xec, 0x8c, 0xfe]).tostring())
        self.conn.read(8)
        self.conn.write(array.array('B', [0xfd,0x00,0x03,0x05,0x01,0x8b,0x7c,0xfe]).tostring())
        self.conn.read(8)
        self.conn.write(array.array('B', [0xfd,0x00,0x04,0x10,0x2d,0xb1,0xfe]).tostring())
        self.conn.read(8)
